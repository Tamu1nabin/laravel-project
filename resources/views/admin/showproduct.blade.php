                   ...
                   <td><img src="{{asset('admin/upload/products')}}/{{$product->product_image}}" width="60"></td>
                    <td>
                      <div class="btn-group">
                        ...
                        <a class="btn btn-danger" href="{{route('admin.deleteproduct',$product->id)}}" onclick="return confirm('Are you sure want to delete this product?')"><i class="icon_close_alt2"></i></a>
                      </div>
                    </td>
                  </tr>
                 @endforeach
